...
class DentalYOLOTrainer:
    ...
    def train(self, 
        ...
        # Configuration d'entraînement simplifiée et compatible
        train_args = {
            ...
            'save': True,
            'val': True,
            'amp': True,  # Automatic Mixed Precision pour accélérer l'entraînement
            'workers': 2,  # Nombre de workers pour le dataloader
            'seed': 42,   # Pour la reproductibilité
            'deterministic': False,  # Permettre un entraînement plus rapide
        }
